var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href",mypublic + "/Home/Css/themes/" + color + (isRTL ? '-rtl' : '') + ".css");
            $('#logoimg').attr("src",mypublic + "/Home/Images/logo_" + color + ".png");
            $('#rev-hint1').attr("src",mypublic + "/Home/Images/sliders/revolution/hint1-" + color + ".png");
            $('#rev-hint2').attr("src",mypublic + "/Home/Images/sliders/revolution/hint2-" + color + ".png");
        }
