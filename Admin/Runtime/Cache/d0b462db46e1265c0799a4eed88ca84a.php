			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="__URL__/index">日志管理</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li><a href="__URL__/index">系统日志列表</a></li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>系统日志列表</div>
                            <div class="tools">
						...
						<div class="portlet-body">
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
										...
										<td><?php echo ($vo["behavior"]); ?></td>
                                        <td><?php echo ($vo["operand"]); ?></td>
                                        <td><?php echo ($vo["result"]); ?></td>
                                        <td width="60px"><?php echo ($vo["dateline"]); ?></td>
                                        <td width="60px">
