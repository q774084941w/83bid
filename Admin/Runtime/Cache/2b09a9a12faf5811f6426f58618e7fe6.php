				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption">
                                <i class="fa fa-user"></i>
                                <?php echo ($thisClassName); ?>列表
                            </div>
                            <div class="actions">
								<a href="javaScript:" id="addPay" class="btn green">
                                    <i class="fa fa-plus"></i>
                                    添加  <?php echo ($thisClassName); ?>
                                </a>
							</div>
						</div>
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        <td><?php echo ($vo["examine_id"]); ?></td>
                                        <td><?php echo ($vo["name"]); ?></td>
                                        <td><?php echo ($vo["time"]); ?></td>
                                        <td><?php echo ($vo['status']==1?'启用中':'禁用了'); ?></td>
                                        <td><?php echo ($vo["aname"]); ?></td>
                                        <td width="168px">
                                            <?php if($vo["examine_id"] > 3): if($vo["status"] == 1): ?><a href="__URL__/update/id/<?php echo ($vo["examine_id"]); ?>/status/2"
                                                       class="btn btn-xs red" style="width:50px;">
                                                        <i class="fa fa-times"></i> 禁用</a>
                                                    <?php else: ?>
                                                    <a href="__URL__/update/id/<?php echo ($vo["examine_id"]); ?>/status/1"
                                        ...
                                        <input type="hidden" value="<?php echo ($vo["examine_id"]); ?>">
    ...
    <div class="modal-dialog"
        ...
        <div class="modal-content">
            ...
            <form action="__URL__/change" method="post" class="js-ajax-form">
                <input type="hidden" name="examine_id" id="payment_id">
                <div class="modal-body">
