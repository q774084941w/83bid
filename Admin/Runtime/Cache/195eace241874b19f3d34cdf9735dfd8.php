                ...
                <!--表格开始-->
                    <div class="portlet box blue">
					    <div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>修改管理员组</div>
							<div class="actions">
										...
										<div class="col-md-9" style="margin-top:8px">
											...
											<?php if(is_array($left)): $i = 0; $__LIST__ = $left;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="limitsdiv">
													<label id="<?php echo ($vo["controller"]); ?>">
														<input type="checkbox" name="limits[]" value="<?php echo ($vo["id"]); ?>"  <?php echo ($checked[$vo['id']]); ?> />
														<?php echo ($vo["name"]); ?>
													</label><br/>
													<?php if(!empty($vo['children'])): ?><label for="<?php echo ($vo["controller"]); ?>">
															<?php if(is_array($vo['children'])): $i = 0; $__LIST__ = $vo['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><label class="limitsinput">
																	<input type="checkbox" name="limits[]" value="<?php echo ($vol["id"]); ?>"  <?php echo ($checked[$vo['id']]); ?>/>
																	<?php echo ($vol["name"]); ?>
