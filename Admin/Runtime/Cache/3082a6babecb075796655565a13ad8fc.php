                ...
                <!--表格开始-->
                    <div class="portlet box yellow">
					    <div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>添加系统收支</div>
							<div class="actions">
							...
							<form action="__URL__/insert" method="post"
								...
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">项目<span class="required">*</span></label>
										<div class="col-md-4">
											<div class="input-icon right">                                       
												<i class="fa"></i>
												<select name="projects" class="form-control"  id="">
													<?php if(is_array($projects)): $i = 0; $__LIST__ = $projects;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>,<?php echo ($vo["pnumber"]); ?>"><?php echo ($vo["pnumber"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">用户<span class="required">*</span></label>
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<select name="users_id" class="form-control"  >
													<?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>">
															<?php if(empty($vo['neckname'])): echo ($vo["uname"]); ?>
																<?php else: ?>
																<?php echo ($vo["neckname"]); endif; ?>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">                                       
												<i class="fa"></i>   
												<input type="text" class="form-control" name="prestore"/>
											</div>
										</div>
                                    </div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												...
												<select name="monetary_id" class="form-control" >
													<?php if(is_array($monetary)): $i = 0; $__LIST__ = $monetary;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["monetary_id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</div>
										</div>
									</div>
										...
										<div class="col-md-4">
											<div class="input-icon right">
												...
												<select name="type" class="form-control"  >
													<option value="1">项目预收</option>
													<option value="2">保证金</option>
													<option value="3">酬谢金</option>
													<option value="4">赔偿金</option>
												</select>
											</div>
										</div>
                                    </div>
