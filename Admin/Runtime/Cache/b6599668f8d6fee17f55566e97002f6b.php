				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>聊天信息</div>
                            <div class="tools">
                                ...
                                <div class="form-body">
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                    <?php if(empty($$vo['picture'])): echo ($vo["content"]); ?>
                                                        <?php else: ?>
                                                        <img src="<?php echo ($vo['picture']); ?>" alt="图片不见了"><?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php echo ($vo["time"]); ?>
                                                </td>
                                                ...
                                                <td>
                                                    <?php if($vo["status"] == 1): ?><a href="__URL__/content/id/<?php echo ($vo["id"]); ?>/status/2"
                                                           class="btn btn-xs red" style="width:50px;">
                                                            <i class="fa fa-times"></i> 屏蔽</a>
                                                        <?php else: ?>
                                                        <a href="__URL__/content/id/<?php echo ($vo["id"]); ?>/status/1"
                                                           class="btn btn-xs blue">
                                                            <i class="fa fa-edit"></i> 正常</a><?php endif; ?>
                                                </td>
