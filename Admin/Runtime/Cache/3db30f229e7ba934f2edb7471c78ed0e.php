                ...
                <!--表格开始-->
                    <div class="portlet box yellow">
					    <div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>修改常见问题</div>
							<div class="actions">
										...
										<div class="col-md-4">
											<div class="input-icon right">
                                                ...
                                                <select name="type_id" id="" class="form-control">
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["type_id"]); ?>" <?php echo ($data['type_id']==$vo['type_id']?'selected':''); ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
											</div>
										</div>
									</div>
