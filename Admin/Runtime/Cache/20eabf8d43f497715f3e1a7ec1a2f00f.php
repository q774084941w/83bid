		...
		<div class="page-content">
			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						控制面板 <small><?php echo ($mgood); echo ($_SESSION['admin']['truename']); ?></small>
					</h3>
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue">
						...
						<div class="details">
							<div class="number">
								<?php echo ($statistics["pro"]); ?>
							</div>
							<div class="desc">                           
								个项目
							</div>
						</div>
						<a class="more" href="__APP__/Projects">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue">
						...
						<div class="details">
							<div class="number">
								<?php echo ($statistics["pro1"]); ?>
							</div>
							<div class="desc">
								个未签约项目
							</div>
						</div>
						<a class="more" href="__APP__/Projects/index/status/0">
						查看更多 <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue">
						...
						<div class="details">
							<div class="number">
								<?php echo ($statistics["pro2"]); ?>
							</div>
							<div class="desc">
								个开发项目
							</div>
						</div>
						<a class="more" href="__APP__/Projects/index/status/1">
						查看更多 <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue">
						...
						<div class="details">
							<div class="number">
								<?php echo ($statistics["pro3"]); ?>
							</div>
							<div class="desc">
								个上架项目
							</div>
						</div>
						<a class="more" href="__APP__/Commodity">
						查看更多 <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat purple">
						...
						<div class="details">
							<div class="number"><?php echo ($statistics["dsenum"]); ?></div>
							<div class="desc">个会员者</div>
						</div>
						<a class="more" href="__APP__/Users/dlist">
						查看更多 <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat yellow">
						...
						<div class="details">
							<div class="number"><?php echo ($statistics["money"]); ?>元</div>
							<div class="desc">收入总计</div>
						</div>
						<a class="more" href="__APP__/SysAccount">
						查看更多 <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
...
<!-- BEGIN SAMPLE TABLE PORTLET-->
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-cogs"></i>系统信息</div>
							<div class="tools">
							...
							<div class="table-responsive">
								<table class="table table-hover">
									<thead>
										<tr>
											<td>服务器操作系统：</td>
											<td><span class="label label-sm label-info"><?php echo ($sys_info["os"]); ?></td>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td>Web 服务器：</td>
											<td><span class="label label-sm label-info"><?php echo ($sys_info["web_server"]); ?></span></td>
										</tr>
										<tr>
											<td>PHP 版本：</td>
											<td><span class="label label-sm label-info"><?php echo ($sys_info["php_ver"]); ?></span></td>
										</tr>
										<tr>
											<td >MySQL 版本:</td>
											<td><span class="label label-sm label-info"><?php echo ($sys_info["mysql"]); ?></span></td>
										</tr>
										<tr>
											<td >ThinkPHP 版本：</td>
											<td><span class="label label-sm label-info"><?php echo (THINK_VERSION); ?></span></td>
										</tr>
										<tr>
											<td >当前登陆ip:</td>
											<td><span class="label label-sm label-warning"><?php echo ($ip); ?></span></td>
										</tr>
										<tr>
											<td >登陆ip所在地:</td>
											<td><span class="label label-sm label-warning"><?php echo ($area); ?></span></td>
										</tr>
									</tbody>
								</table>
							</div>
...
<div class="col-md-6 col-sm-6">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa  fa-bookmark-o"></i>最近项目</div>

						</div>
						<div class="portlet-body">
							<div class="scroller" style="height: 220px;" data-always-visible="1" data-rail-visible="0">
								<ul class="feeds">
										...
										<div class="col1">
											<div class="cont">
												<div class="cont-col1">
													...
													<?php switch($vo['status']): case "0": ?><div class="label label-sm label-danger">
																<i class="fa fa-flag"></i>
															</div><?php break;?>
														<?php case "1": ?><div class="label label-sm label-warning">
												...
												<div class="cont-col2">
													<div class="desc">
														<a href="__APP__/Projects/view/id/<?php echo ($vo["id"]); ?>">
															<?php echo ($vo["pname"]); ?>
														</a>
														<?php switch($vo['status']): case "0": ?><div class="label label-sm label-danger">
																	正在竞标中
