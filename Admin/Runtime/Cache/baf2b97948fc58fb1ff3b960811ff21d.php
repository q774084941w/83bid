				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>雇佣者评论详情</div>
                            <div class="tools">
                                ...
                                <div class="form-body">
                                   <h3 class="form-section">评论信息</h3>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["reviewerid"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <!--<div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">评论等级详情:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["leveldetails"]); ?></p>
                                                </div>
                                            </div>
                                        </div>-->
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["comtime"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">平均评论等级:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["averagelevel"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["replytime"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">被评论者ID:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["byreviewerid"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <!--/row-->
                                    <h3 class="form-section">评论详细信息</h3>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["reply"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-offset-10 col-md-2">
                                                ...
                                                <a href="__URL__/elist" class="btn purple"><i class="fa fa-share"></i> 返回</a>
                                            </div>
                                        </div>
