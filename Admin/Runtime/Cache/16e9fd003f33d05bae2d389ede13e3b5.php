				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>币值列表</div>
                            <div class="actions">
								<a href="javaScript:" id="addPay" class="btn green"><i class="fa fa-plus"></i> 添加币值</a>
							</div>
						</div>
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        <td><?php echo ($vo["monetary_id"]); ?></td>
                                        <td><?php echo ($vo["title"]); ?></td>
                                        <td><?php echo ($vo["conversion"]); ?>%</td>
                                        <td><?php echo ($vo["icon"]); ?></td>
                                        <td><?php echo ($vo["time"]); ?></td>
                                        <td><?php echo ($vo['status']==1?'启用中':'禁用了'); ?></td>
                                        <td width="168px">
                                            <?php if($vo["status"] == 1): ?><a href="__URL__/update/id/<?php echo ($vo["monetary_id"]); ?>/status/2"
                                                class="btn btn-xs red" style="width:50px;">
                                                    <i class="fa fa-times"></i> 禁用</a>
                                            <?php else: ?>
                                                <a href="__URL__/update/id/<?php echo ($vo["monetary_id"]); ?>/status/1"
                                        ...
                                        <input type="hidden" value="<?php echo ($vo["monetary_id"]); ?>">
            ...
            <form action="__URL__/add" method="post" id="apply_form" class="js-ajax-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="txt_remark">换算比例</label>

                        <input type="text"
                               name="conversion"
                               class="form-control"
                               placeholder="和人民币兑换比例，请输入整数">

                    </div>
                    <div class="form-group">

                        <label for="txt_remark">图标符号</label>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               name="conversion"
                               class="form-control"
                               id="monetary_conversion"
                               placeholder='%'>

                    </div>
                    <div class="form-group">

                        <label for="txt_remark">符号</label>
...
<script>
    ...
    $('[name="change"]').click(function () {
        ...
        $('#monetary_title').val(thisTd.parent().children().eq(1).text());
        var conversion = thisTd.parent().children().eq(2).text();
        conversion = conversion.replace('%','');
        $('#monetary_conversion').val(conversion);
        $('#monetary_icon').val(thisTd.parent().children().eq(3).text());
        $('#myModal2').modal();
    });
</script>