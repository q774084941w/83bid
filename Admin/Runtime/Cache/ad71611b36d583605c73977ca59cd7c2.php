...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu">
        ...
        <li class="<?php switch($thisNavigation1): case "Projects": ?>open<?php break;?>
            <?php case "Bidders": ?>open<?php break;?>
            ...
            <?php case "Bidders": ?>block<?php break;?>
            <?php case "Classify": ?>block<?php break;?>
            <?php default: ?>none<?php endswitch;?>">
                <li class="tooltips <?php echo ($thisNavigation=='Projects/'?'active':''); ?>" data-placement="right" data-original-title="点击查看项目">
                    <a href="__APP__/Projects">
                        项目列表</a>
                </li>
                <li class="tooltips <?php echo ($thisNavigation=='ClassifyAction/'?'active':''); ?>" data-placement="right" data-original-title="点击查看项目">
                    <a href="__APP__/Classify">
                        项目分类</a>
                </li>
                <li class="tooltips <?php echo ($thisNavigation=='Bidders/'?'active':''); ?>" data-placement="right" data-original-title="点击查看竞标者">
        ...
        <li class="<?php switch($thisNavigation1): case "SysAccount": ?>open<?php break;?>
            ...
            <?php default: ?>none<?php endswitch;?>">
                <li class="tooltips <?php echo ($thisNavigation=='SysAccount/'?'active':''); ?>" data-placement="right" data-original-title="点击查看系统账户">
                    <a href="__APP__/SysAccount">
                        系统账户管理</a>
                </li>
                <li class="tooltips <?php echo ($thisNavigation=='UserAccount/'?'active':''); ?>" data-placement="right" data-original-title="点击查看用户账户">
				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>站内信详情</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    <h2 class="margin-bottom-20"> 站内信 - <?php echo ($info["title"]); ?> </h2>
                                    <h3 class="form-section">站内信</h3>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">发送用户ID:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["senderid"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">接收用户ID:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["receiverid"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["sendtime"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <!--<div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">读取状态:</label>
                                                <div class="col-md-9">
