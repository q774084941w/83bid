				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>账号交易详情</div>
                            <div class="actions">
						...
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        ...
                                        <td><?php echo ($vo['transtype']==1?'充值':'提现'); ?></td>
                                        <td><?php echo ($vo["time"]); ?></td>
                                        <td>
											<a href="__APP__/UserAccount/view/id/<?php echo ($vo["id"]); ?>" class="btn btn-xs yellow">
