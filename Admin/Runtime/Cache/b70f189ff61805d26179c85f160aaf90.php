				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>问题详情</div>
                            <div class="tools">
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php if(empty($info["nickname"])): echo ($info["uname"]); ?>
                                                            <?php else: ?>
                                                            <?php echo ($info["nickname"]); endif; ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["examine"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">评论状态:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php switch($info['status']): case "1": ?>显示<?php break;?>
                                                            <?php case "2": ?>隐藏<?php break;?>
                                                            <?php default: ?>
                                                            未知属性<?php endswitch;?>
                                                    </p>
                                                </div>
                                    ...
                                    <!--/row-->
                                    <?php if(!empty($list)): ?><table class="table table-striped table-bordered table-hover" id="sample_2">
                                            <thead>
                                            <tr>
                                                <th>#ID</th>
                                                <th>标题</th>
                                            ...
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <?php if(empty($vo['nickname'])): echo ($vo["uname"]); ?>
                                                            <?php else: ?>
                                                            <?php echo ($vo["nickname"]); endif; ?>
                                                    </td>
                                                    <td><?php echo ($vo["examine"]); ?></td>
                                                    <td>
                                                        <?php echo date('Y-m-d H:i:s',$vo['createtime']); ?>
                                                    </td>
                                                    <td>
                                                        <?php switch($vo["status"]): case "2": ?>屏蔽<?php break;?>
                                                            <?php case "1": ?>显示<?php break;?>
                                                            <?php default: ?>
                                                            未知属性<?php endswitch;?>
                                                    </td>
                                                    <td width="168px">
                                                        <?php if($vo["status"] == 1): ?><a href="__URL__/update/id/<?php echo ($vo["id"]); ?>/status/2" class="btn btn-xs blue"><i class="fa fa-edit"></i> 屏蔽</a>
                                                            <?php else: ?>
                                                            <a href="__URL__/update/id/<?php echo ($vo["id"]); ?>/status/1" class="btn btn-xs red"><i class="fa fa-times"></i> 显示</a><?php endif; ?>
                                                        <a href="__URL__/view/id/<?php echo ($vo["id"]); ?>" class="btn btn-xs yellow"><i class="fa fa-file-o"></i> 详情</a>
                                                    </td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-offset-10 col-md-2">
                                                ...
                                                <a href="javaScript:history.back(-1)" class="btn purple">
