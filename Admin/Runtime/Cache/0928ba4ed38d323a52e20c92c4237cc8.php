				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>后台菜单列表</div>
                            <div class="actions">
								<a href="__URL__/add" class="btn green"><i class="fa fa-plus"></i> 添加后台菜单</a>
							</div>
						</div>
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        <td style='padding-left:20px;'>
											...
											<input type="text" name="list_order[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["list_order"]); ?>" class='input input-order'>
										</td>
                                        <td><?php echo ($vo["id"]); ?></td>
                                        <td><?php echo ($vo["name"]); ?></td>
										<td><?php echo ($vo["app"]); ?>/<?php echo ($vo["controller"]); ?>/<?php echo ($vo["action"]); ?></td>
                                        <td>
											<?php switch($vo['status']): case "1": ?>显示<?php break;?>
												<?php case "0": ?>隐藏<?php break;?>
												<?php default: endswitch;?>
										</td>
                                        <td width="168px">
											<a href="__URL__/add/parent_id/<?php echo ($vo["id"]); ?>" class="btn btn-xs green"><i class="fa fa-file-o"></i> 添加子菜单</a>
											<a href="__URL__/mod/id/<?php echo ($vo["id"]); ?>" class="btn btn-xs blue"><i class="fa fa-edit"></i> 编辑</a>
											<a href="__URL__/del/id/<?php echo ($vo["id"]); ?>" class="btn btn-xs red"><i class="fa fa-times"></i> 删除</a>
                                        </td>
                                    </tr>
									<?php if(!empty($vo['children'])): if(is_array($vo['children'])): $i = 0; $__LIST__ = $vo['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
												<td style='padding-left:20px;'>
												...
												<td><?php echo ($vol["app"]); ?>/<?php echo ($vol["controller"]); ?>/<?php echo ($vol["action"]); ?></td>
												<td>
													<?php switch($vol['status']): case "1": ?>显示<?php break;?>
														<?php case "0": ?>隐藏<?php break;?>
														<?php default: endswitch;?>
												</td>
												<td width="168px">
													<a href="__URL__/add/parent_id/<?php echo ($vol["id"]); ?>" class="btn btn-xs green"><i class="fa fa-file-o"></i> 添加子菜单</a>
													<a href="__URL__/mod/id/<?php echo ($vol["id"]); ?>" class="btn btn-xs blue"><i class="fa fa-edit"></i> 编辑</a>
													<a href="__URL__/del/id/<?php echo ($vol["id"]); ?>" class="btn btn-xs red"><i class="fa fa-times"></i> 删除</a>
												</td>
