                ...
                <!--表格开始-->
                    <div class="portlet box yellow">
					    <div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>修改商品</div>
							<div class="actions">
								...
								<div class="form-body">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												...
												<select name="projects" class="form-control">
													<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>,<?php echo ($vo["pnumber"]); ?>"  <?php echo ($vo['id']==$data['projects_id']?'selected':''); ?>>
															<?php echo ($vo["pnumber"]); ?>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" name="price" required value="<?php echo ($data["price"]); ?>"/>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="file" class="form-control" name="img" required onchange="xmTanUploadImg(this)" value="<?php echo ($data["img"]); ?>"/>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<select name="install" id=""  class="form-control" >
													<option value="1" <?php echo ($data['install']==1?'selected':''); ?>>否</option>
													<option value="2" <?php echo ($data['install']==2?'selected':''); ?>>是</option>
												</select>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<select name="modify" id=""  class="form-control" >
													<option value="1" <?php echo ($data['modify']==1?'selected':''); ?>>否</option>
													<option value="2" <?php echo ($data['modify']==2?'selected':''); ?>>是</option>
												</select>
											</div>
										</div>
									</div>
									...
									<div class="form-group" style="text-align: center">
										...
										<div class="col-sm-8">
											<textarea id="content" name="content" required><?php echo ($data["content"]); ?></textarea>
										</div>
										<div class="col-sm-2"></div>
									</div>
