				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>评论详情</div>
                            <div class="tools">
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php if(empty($info['byneckname'])): echo ($info["byreviewerid"]); ?>
                                                            <?php else: ?>
                                                            <?php echo ($info["byneckname"]); endif; ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">评论者:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php if(empty($info['reneckname'])): echo ($info["reviewerid"]); ?>
                                                            <?php else: ?>
                                                            <?php echo ($info["reneckname"]); endif; ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-offset-10 col-md-2">
                                                ...
                                                <a href="__URL__/dlist" class="btn purple"><i class="fa fa-share"></i> 返回</a>
                                            </div>
                                        </div>
