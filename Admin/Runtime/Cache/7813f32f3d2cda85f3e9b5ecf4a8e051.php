				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>管理员组详情</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    <h2 class="margin-bottom-20"> 管理员组信息 - <?php echo ($info["title"]); ?> </h2>
                                    <h3 class="form-section">基本信息</h3>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">组ID:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["id"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">创建者:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["creator"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">浏览用户</p>
                                                    <p class="form-control-static">浏览用户</p>
                                                    <p class="form-control-static">浏览用户</p>
                                                </div>
                                            </div>
                                        ...
                                        <!--<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">浏览管理员</p>
                                                    <p class="form-control-static">浏览管理员</p>
                                                    <p class="form-control-static">浏览管理员</p>
                                                </div>
                                            </div>
