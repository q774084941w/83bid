				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>项目详情</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    <h2 class="margin-bottom-20"> 项目信息 - <?php echo ($info["pname"]); ?> </h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["pnumber"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["category"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
									...
									<div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["pname"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["eid"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
									...
									<div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">项目预算:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["budget"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <!--/row-->
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-offset-10 col-md-2" >
                                                <a class="btn purple pull-right" data-toggle="modal" data-target="#myModal">
                                    ...
                                    <!--/row-->
                                    <h3 class="form-section">项目状态</h3>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">项目当前状态:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">项目发布时间:</label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">项目预计时长:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["projecttime"]); ?>小时</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">竞标时长:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["biddingtime"]); ?>小时</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        ...
                                                        <a href="__URL__/work/id/<?php echo ($info["id"]); ?>"
                                                           class="btn btn-xs yellow">
                                                            <?php echo ($info["delivery"]); ?>
                                                        </a>
                                                    </p>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <a href="__URL__/work/id/<?php echo ($info["id"]); ?>/type/2"
                                                           class="btn btn-xs yellow">
                                                            <?php echo ($info["work_num"]); ?>
                                                        </a>
                                                    </p>
                                                </div>
                                            </div>
									...
									<div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">结束或终止时间:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php if(empty($info['endtime'])): ?>未完成
                                                            <?php else: ?>
                                                            <?php echo date('Y-m-d H:i:s',$info['endtime']); endif; ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">是否收取预算:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php switch($info['have_in']): case "1": ?>未收取<?php break;?>
                                                            <?php case "2": ?>已收取<?php break;?>
                                                            <?php default: ?>
                                                            未知属性<?php endswitch;?>
                                                    </p>
                                                </div>
                                    ...
                                    <h3 class="form-section">项目问题</h3>
                                    <div class="row">
                                        <?php if(is_array($question)): $k = 0; $__LIST__ = $question;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="form-group">
                                                <label class="control-label col-md-3">问题<?php echo ($k); ?>:</label>
                                                <div class="col-md-6">
                                                    <p class="form-control-static">
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-offset-10 col-md-2">
                                                <a href="javaScript:history.back(-1)" class="btn purple pull-right"><i class="fa fa-share"></i> 返回</a>
                                            </div>
                                        </div>
                                        <div class="col-md-6"></div>
                                    </div>
