...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu">
        ...
        <li class="<?php switch($thisNavigation1): case "Examine": ?>open<?php break;?>
            ...
            <?php default: ?>none<?php endswitch;?>">
                <li class="tooltips <?php echo ($thisNavigation1=='Examine'?'active':''); ?>" data-placement="right" data-original-title="点击查看项目审核信息">
                    <a href="__APP__/Examine">
                        项目审核列表
                    </a>
                </li>
                <li class="tooltips <?php echo ($thisNavigation1=='QExamine'?'active':''); ?>" data-placement="right" data-original-title="点击查看问答审核信息">
		...
		<div class="page-content">
			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						<?php echo ($sysmanage["title"]); ?> <small>后台管理</small>
					</h3>
							...
							<div class="tab-pane"  id="tab_4">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption"><i class="fa fa-reorder"></i>站点信息</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="__URL__/update"  method="post" class="form-horizontal form-row-seperated" enctype="multipart/form-data">
											<div class="form-body">
												<div class="form-group">
													<label class="control-label col-md-3">网站标题</label>
													<div class="col-md-9">
														<input type="text" placeholder="请输入网站标题" name="title" class="form-control" value="<?php echo ($info["title"]); ?>"/>
														<span class="help-block">这是网站的标题</span>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">网站logo</label>
													<div class="col-md-9" style="text-align: center;">
														<input type="file" name="logo" value="<?php echo ($info["logo"]); ?>" onchange="xmTanUploadImg(this)">
															<img src="<?php if(empty($info['logo'])): ?>__PUBLIC__/Images/logo.png<?php else: echo ($info["logo"]); endif; ?>"
																 width="135" style="cursor: pointer"/>

													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">网站图标</label>
													<div class="col-md-9" style="text-align: center;">
														<input type="file" name="icon" value="<?php echo ($info["icon"]); ?>" onchange="xmTanUploadImg(this)">
															<img src="<?php if(empty($info['icon'])): ?>__PUBLIC__/Images/logo.png<?php else: echo ($info["icon"]); endif; ?>"
																 width="67" style="cursor: pointer"/>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" name="keywords" class="form-control tags" id="keywords" value="<?php echo ($info["keywords"]); ?>" data-role="tagsinput" placeholder="add tags" />
														<!--<input type="text" name="keywords" class="form-control" id="keywords" placeholder="add tags" />-->
														<span class="help-block">这是网站的关键字</span>
													</div>
                                                </div>
                                                <div class="form-group">
													<label class="control-label col-md-3">客服电话</label>
													<div class="col-md-9">
														<input type="text" placeholder="请输入客服电话" name="phone" class="form-control" value="<?php echo ($info["phone"]); ?>"/>
														<span class="help-block">这是网站的客服电话</span>
													</div>
                                                </div>
                                                <div class="form-group">
													<label class="control-label col-md-3">客服邮箱</label>
													<div class="col-md-9">
														<input type="text" placeholder="请输入客服邮箱" name="email" class="form-control" value="<?php echo ($info["email"]); ?>"/>
														<span class="help-block">这是网站的客服邮箱</span>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">网站描述</label>
													<div class="col-md-9">
														<textarea name="description" class="form-control" rows="3"><?php echo ($info["description"]); ?></textarea>
														<span class="help-block">这是网站的描述.</span>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">上次修改时间</label>
													<div class="col-md-9">
														<label class="control-label "><?php echo ($info["lasttime"]); ?></label>
													</div>
												</div>
											</div>
