				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>Rank规则列表</div>
                            <div class="actions">
								<a href="__URL__/add" class="btn green"><i class="fa fa-plus"></i> 添加规则</a>
							</div>
						</div>
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        ...
                                        <td style="overflow-x: scroll"><?php echo ($vo["content"]); ?></td>
                                        <td><?php echo ($vo["aname"]); ?></td>
                                        <td><?php echo ($vo["time"]); ?></td>
                                        <td width="168px">
                                            <?php if($vo["status"] == 1): ?><a href="__URL__/update/id/<?php echo ($vo["rank_id"]); ?>/status/2"
                                                class="btn btn-xs red" style="width:50px;">
                                                    <i class="fa fa-times"></i> 禁用</a>
                                            <?php else: ?>
                                                <a href="__URL__/update/id/<?php echo ($vo["rank_id"]); ?>/status/1"
                                                class="btn btn-xs blue">
                                                    <i class="fa fa-edit"></i> 启用</a><?php endif; ?>
                                            <a href="__URL__/change/id/<?php echo ($vo["rank_id"]); ?>"
                                                class="btn btn-xs yellow">
                                                <i class="fa fa-file-o"></i> 修改</a>
