			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="__URL__/index">项目列表</a></li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>投标列表</div>
                            <div class="actions">
						...
						<div class="portlet-body">
                            <form action="__URL__/del" method="post">
								...
								<div class="group">
									<div class="col-sm-4">
										项目编号：<?php echo ($project["pnumber"]); ?>
									</div>
									<div class="col-sm-4">
										项目名称：<?php echo ($project["pname"]); ?>
									</div>
									<div class="col-sm-4">
										项目发布人：<?php echo ($project["uname"]); ?>
									</div>
								</div>
								...
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        ...
                                        <td>
											<span class="label label-sm label-success">
												<?php switch($vo['result']): case "0": ?>正在竞标中<?php break;?>
										...
										<td>
											<span class="label label-sm label-success">
												<?php switch($vo['status']): case "1": ?>协商中<?php break;?>
													<?php case "2": ?>合作中<?php break;?>
													<?php case "3": ?>项目未完成<?php break;?>
													<?php case "4": ?>项目完成一部分<?php break;?>
													<?php case "5": ?>项目完成<?php break;?>
													<?php default: ?>
														未加载的状态<?php endswitch;?>
											</span>
										</td>
										<td><?php echo ($vo["createtime"]); ?></td>
                                        <td>
                                             <a href="__URL__/worker/id/<?php echo ($vo["id"]); ?>" class="btn btn-xs yellow">
