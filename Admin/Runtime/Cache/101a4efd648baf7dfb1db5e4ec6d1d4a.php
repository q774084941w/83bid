                ...
                <!--表格开始-->
                    <div class="portlet box yellow">
					    <div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>添加用户</div>
							<div class="actions">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="__URL__/insert" method="post" id="form_sample_0" class="form-horizontal" enctype="multipart/form-data">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" name="neckname"/>
											</div>
										</div>
									</div>
									<div class="form-group">
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">重复密码<span class="required">*</span></label>
										<div class="col-md-4">
											<div class="input-icon right">                                       
												<i class="fa"></i>   
									...
									<div class="form-group">
										<label class="control-label col-md-3">用户电话<span class="required">*</span></label>
										<div class="col-md-4">
											<div class="input-icon right">                                       
												<i class="fa"></i>   
									...
									<div class="form-group">
										<label class="control-label col-md-3">用户电子邮箱<span class="required">*</span></label>
										<div class="col-md-4">
											<div class="input-icon right">                                       
												<i class="fa"></i>   
												<input type="text" class="form-control" name="email"/>
											</div>
                                            <!--<span class="help-block">示例: http://www.demo.com or http://demo.com</span>-->
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">用户所在地<span class="required">*</span></label>
										<div class="col-md-4">
											<div class="input-icon right">                                       
												<i class="fa"></i>   
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">上传用户头像<span class="required">*</span></label>
                                        <div class="col-md-4">
                                            <input style="padding-left:2px;" type="file" id="exampleInputFile" name="avatar">
                                        </div>
										
                                    </div>
                                    <div class="form-group">
										<label class="control-label col-md-3">开发者技能<span class="required">*</span></label>
										<div class="col-md-6">
											<div class="input-icon right">                                       
												<i class="fa"></i>
												<?php if(is_array($skill)): $i = 0; $__LIST__ = $skill;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><span class="limitsinput">
														<input type="checkbox" name="skills[]" value="<?php echo ($vo["skill_id"]); ?>">
														<?php echo ($vo["name"]); ?>
