				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>身份证认证</div>
                            <div class="tools">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php if(empty($$data['real_name'])): ?>未认证
                                                            <?php else: ?>
                                                            $data['real_name']<?php endif; ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <img src="
                                                     <?php if(empty($$data['positive'])): ?>/Public/Images/picture.png
                                                    <?php else: ?>
                                                    $data['positive']<?php endif; ?>
                                                   " alt="" class="ID">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <img src="
                                                     <?php if(empty($$data['opposite'])): ?>/Public/Images/picture.png
                                                    <?php else: ?>
                                                    $data['opposite']<?php endif; ?>
                                                   " alt="" class="ID">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <img src="
                                                     <?php if(empty($$data['face'])): ?>/Public/Images/photo2.e9cc726.png
                                                    <?php else: ?>
                                                    $data['face']<?php endif; ?>
                                                   " alt="" class="ID">
                                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>工作背景认证
                            </div>
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                        <?php if(is_array($company)): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                <td><?php echo ($vo["id"]); ?></td>
                                                <td><?php echo ($vo["company"]); ?></td>
                                                <td><?php echo ($vo["address"]); ?></td>
                                                <td>
                                                    <a href="__URL__/company/id/<?php echo ($vo["id"]); ?>"
