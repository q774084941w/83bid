						...
						<div class="portlet-body">
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        ...
                                        <td width="168px">
                                            <?php switch($vo["examine_id"]): case "1": ?><a href="__URL__/adopt/id/<?php echo ($vo["id"]); ?>/examine/2" class="btn btn-xs green">
                                                        <i class="fa fa-file-o"></i>
                                                        通过
                                                    </a>
                                                    <a href="__URL__/adopt/id/<?php echo ($vo["id"]); ?>/examine/3" class="btn btn-xs red">
                                                        <i class="fa fa-file-o"></i>
                                                        不通过
                                                    </a><?php break;?>
                                                <?php case "2": ?><a href="__URL__/adopt/id/<?php echo ($vo["id"]); ?>/examine/3" class="btn btn-xs red">
                                                        <i class="fa fa-file-o"></i>
                                                        不通过
                                                    </a><?php break;?>
                                                <?php case "3": ?><a href="__URL__/adopt/id/<?php echo ($vo["id"]); ?>/examine/2" class="btn btn-xs red">
                                                        <i class="fa fa-file-o"></i>
                                                        通过
                                                    </a><?php break;?>
                                                <?php default: ?>
                                                未知<?php endswitch;?>
                                             <a href="__APP__/Interlocution/view/id/<?php echo ($vo["id"]); ?>" class="btn btn-xs yellow">
                                                 <i class="fa fa-file-o"></i>
                                                 详情
                                             </a>
                                        </td>
