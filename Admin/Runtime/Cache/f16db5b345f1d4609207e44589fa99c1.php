				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>项目列表</div>
                            <div class="actions">
								<a href="__URL__/add" id="addPay" class="btn green">
						...
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
										...
										<td class="center"><?php echo ($vo["category"]); ?></td>
                                        <td>
											<span class="label label-sm label-success">
												<?php switch($vo['status']): case "0": ?>正在竞标中<?php break;?>
													<?php case "1": ?>正在开发中<?php break;?>
													<?php default: ?>
														已完成<?php endswitch;?>
											</span>
										</td>
                                        ...
                                        <td>
                                             <a href="__URL__/view/id/<?php echo ($vo["id"]); ?>" class="btn btn-xs yellow">
