                ...
                <!--表格开始-->
                    <div class="portlet box blue">
					    <div class="portlet-title">
							...
							<div class="actions">
								<a href="__URL__/index" class="btn green">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="__URL__/modPost" method="post" class="form-horizontal">
								...
								<div class="form-body">
										...
										<div class="col-md-4">
											<div class="input-icon right">                                       
												...
												<select name="parent_id" id="" class="form-control">
													...
													<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php echo ($vo['id']==$info['parent_id']?'selected':''); ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="input-name" name="name" required value="<?php echo ($info["name"]); ?>">
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="input-app" name="app" required  value="<?php echo ($info["app"]); ?>">
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="input-controller" name="controller" required  value="<?php echo ($info["controller"]); ?>">
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="input-action" name="action" required  value="<?php echo ($info["action"]); ?>">
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="input-param" name="param"  value="<?php echo ($info["param"]); ?>">
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="input-icon" name="icon"  value="<?php echo ($info["icon"]); ?>">
												<p class="help-block">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<textarea class="form-control" id="input-remark" name="remark"> <?php echo ($info["remark"]); ?></textarea>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												...
												<select class="form-control" name="status">
													<option value="1" <?php echo ($info['status']==1?'selected':''); ?>>
													在左侧菜单显示
													</option>
													<option value="0" <?php echo ($info['status']==0?'selected':''); ?>>在左侧菜单隐藏</option>
												</select>
											</div>
										</div>
									</div>
										...
										<div class="col-md-4">
											<div class="input-icon right">
												...
												<select class="form-control" name="type" id="input-type">
													<option value="1" <?php echo ($info['type']==1?'selected':''); ?>>有界面可访问菜单</option>
													<option value="2" <?php echo ($info['type']==2?'selected':''); ?>>无界面可访问菜单</option>
													<option value="0" <?php echo ($info['type']==0?'selected':''); ?>>只作为菜单</option>
												</select>
											</div>
										</div>
									</div>
