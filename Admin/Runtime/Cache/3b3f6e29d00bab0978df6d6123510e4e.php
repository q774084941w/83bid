				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>记录详情</div>
                            <div class="tools">
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["icon"]); echo ($info["prestore"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">人员:</label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php switch($info['status']): case "0": ?>收入<?php break;?>
                                                            <?php case "1": ?>支出<?php break;?>
                                                            <?php default: ?>
                                                            未知状态<?php endswitch;?>
                                                    </p>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php echo date('Y-m-f H:i:s',$info['prestoretime']); ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php switch($info['type']): case "1": ?>项目预收<?php break;?>
                                                            <?php case "2": ?>保证金<?php break;?>
                                                            <?php case "3": ?>酬谢金<?php break;?>
                                                            <?php case "4": ?>赔偿金<?php break;?>
                                                            <?php default: ?>
                                                            未知状态<?php endswitch;?>
                                                    </p>
                                                </div>
