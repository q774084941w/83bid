    ...
    <ul class="page-sidebar-menu">
        ...
        <li class="<?php switch($thisNavigation1): case "AdminGroup": ?>open<?php break;?>
            ...
            <?php default: endswitch;?>">
                ...
                <li  class="tooltips <?php echo ($thisNavigation1=='AdminMenu'?'active':''); ?>" data-placement="right" data-original-title="点击添加管理员组">
			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="__URL__/index">统计管理</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li><a href="__URL__/index">统计列表</a></li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>统计列表</div>
						</div>
						<div class="portlet-body">
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        ...
                                        <td><?php echo ($vo["utotal"]); ?></td>
										<td><?php echo ($vo["ptotal"]); ?></td>
										<td><?php echo ($vo["atotal"]); ?></td>
										<td>
