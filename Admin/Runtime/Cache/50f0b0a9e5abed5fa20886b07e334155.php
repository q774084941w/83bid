				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>详情</div>
                            <div class="tools">
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">投标人:</label>
                                                <div class="col-md-9">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">投标时间:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["createtime"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">保证金:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["bond"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">币值:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["title"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php switch($info['result']): case "0": ?>竞标中<?php break;?>
                                                            <?php case "1": ?>竞标失败<?php break;?>
                                                            <?php case "2": ?>竞标成功<?php break;?>
                                                            <defalut/>
                                                            未知状态<?php endswitch;?>
                                                    </p>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php switch($info['hand_in']): case "1": ?>未缴纳<?php break;?>
                                                            <?php case "2": ?>已经缴纳<?php break;?>
                                                            <defalut/>
                                                            未知状态<?php endswitch;?>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php switch($info['status']): case "1": ?>协商中<?php break;?>
                                                            <?php case "2": ?>合作中<?php break;?>
                                                            <?php case "3": ?>项目未完成<?php break;?>
                                                            <?php case "4": ?>项目完成一部分<?php break;?>
                                                            <?php case "5": ?>项目完成<?php break;?>
                                                            <defalut/>
                                                            未知状态<?php endswitch;?>
                                                    </p>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php if(empty($info['end_time'])): ?>未完成
                                                            <?php else: ?>
                                                            <?php echo date('Y-m-d H:i:s',$info['end_time']); endif; ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
									...
									<div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <?php echo ($info["enclosure"]); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <h3 class="form-section">项目问题答案</h3>
                                    <?php if(is_array($answer)): $k = 0; $__LIST__ = $answer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">问题<?php echo ($k); ?>:</label>
                                                    <div class="col-md-9">
                                                        <p class="form-control-static"> <?php echo ($vo["question"]); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p class="form-control-static"><?php echo ($vo["answer"]); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-offset-10 col-md-2">
                                                <a href="javaScript:history.back(-1)" class="btn purple pull-right">
