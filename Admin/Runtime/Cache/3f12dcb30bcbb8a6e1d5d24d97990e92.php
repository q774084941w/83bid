			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="__URL__/index">用户账户管理</a></li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>交易记录列表</div>
						...
						<div class="portlet-body">
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
										...
										<td>
											<?php switch($vo['transtype']): case "1": ?>充值<?php break;?>
												<?php case "2": ?>提现<?php break;?>
												<?php default: ?>
												未知属性<?php endswitch;?>
										</td>
                                        <td><?php echo ($vo["transcash"]); ?></td>
                                        <td><?php echo ($vo["transid"]); ?></td>
										<td><?php echo ($vo["transtime"]); ?></td>
                                        <td><span class="label label-sm label-success"><?php echo ($vo["balance"]); ?></span></td>
                                        <td> 
