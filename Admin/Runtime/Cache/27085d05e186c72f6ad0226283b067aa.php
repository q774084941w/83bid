			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="__URL__/index">账户管理</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li><a href="__URL__/index">系统账户管理</a></li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>系统收支记录</div>
                            <div class="actions">
								<a href="__URL__/add" class="btn green"><i class="fa fa-plus"></i> 添加系统收支</a>
							</div>
						</div>
						<div class="portlet-body">
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
										...
										<td><?php echo ($vo["icon"]); echo ($vo["prestore"]); ?></td>
										<td><?php echo ($vo["title"]); ?></td>
                                        <td>

											<?php switch($vo['status']): case "0": ?>收入<?php break;?>
                                        ...
                                        <td>
											...
											<?php switch($vo['type']): case "1": ?>项目预收<?php break;?>
