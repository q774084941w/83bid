                ...
                <!--表格开始-->
                    <div class="portlet box blue">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="__URL__/add" method="post" class="form-horizontal">
								<div class="form-body">
										...
										<div class="col-md-4">
											<div class="input-icon right">                                       
												...
												<select name="parent_id" id="" class="form-control">
													...
													<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php echo ($vo['id']==$parent_id?'selected':''); ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="input-app" name="app" required>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="input-controller" name="controller" required>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="input-action" name="action" required>
											</div>
										</div>
									</div>
									<div class="form-group">
