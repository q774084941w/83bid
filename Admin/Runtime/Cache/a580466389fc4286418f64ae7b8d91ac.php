				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>用户详情</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <?php $admin_id = session('admin')['id']; ?>
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    <h3 class="margin-bottom-20">用户头像　 
                                    <img style="height:100px;width:100px;" src="__ROOT__/Uploads/users/<?php echo ($info["avatar"]); ?>">
                                    </h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["uname"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <?php if($admin_id == 1): ?><div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">电话:</label>
                                                    <div class="col-md-9">
                                                        <p class="form-control-static"><?php echo (($info["phone"])?($info["phone"]):'用户暂未填写'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">用户账户:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php echo ($info["account"]); ?>

                                                    <a
                        href="__URL__/account/id/<?php echo ($info["id"]); ?>"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">用户所在地:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo (($info["location"])?($info["location"]):'用户暂未填写'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">用户评分:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["dlevel"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php switch($info["status"]): case "1": ?>启用<?php break;?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">rank积分</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["rank"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    </div>
                                    <h4 class="form-section">开发者技能</h4>
                                    <!--/row-->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <p class="form-control-static">
                                                        <?php if(empty($skill)): ?>未选取

                                                            <?php else: ?>

                                                            <?php if(is_array($skill)): $i = 0; $__LIST__ = $skill;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><span class="btn btn-xs green">
                                                                    <?php echo ($vo["name"]); ?>
                                    ...
                                    <h4 class="form-section">摘要</h4>
                                    <!--/row-->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <p class="form-control-static"><?php echo (($info["abstract"])?($info["abstract"]):'用户暂未填写'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-offset-10 col-md-2">
                                                <a href="__URL__/index" class="btn purple">
                                                    <i class="fa fa-share"></i> 返回</a>
                                            </div>
                                        </div>
