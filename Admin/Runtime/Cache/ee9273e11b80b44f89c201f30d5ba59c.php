				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>修改管理员信息</div>
							<div class="actions">
						...
						<div class="portlet-body form">
							...
							<form action="__URL__/update" method="post" class="form-horizontal">
								<div class="form-body">
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">管理员组</label>
                                        <div class="col-md-4">
                                            <?php echo ($group); ?>
										</div>
                                    </div>
										...
										<div class="col-md-4">
                                            <div class="radio-list">
                                                <label class="radio-inline">
                                                    <div class="radio">
                                                        <input type="radio" name="status" value="0" <?php echo ($info['check1']); ?> />
                                                    </div>
                                                    启用
                                                </label>
                                                <label class="radio-inline">
                                                    <div class="radio">
                                                        <input type="radio" name="status" value="1" <?php echo ($info['check2']); ?> />
                                                    </div>
                                                    禁用
                                                </label>
                                            </div>
