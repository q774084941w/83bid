			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="__URL__/elist">评论雇佣者列表</a></li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>评论雇佣者列表</div>
						</div>
						<div class="portlet-body">
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
										...
										<td><?php echo ($vo["reviewerid"]); ?></td>
										<td><?php echo ($vo["comtime"]); ?></td>
                                        <td><span class="label label-sm label-success"><?php echo ($vo["averagelevel"]); ?></span></td>
                                        <td><?php echo ($vo["replytime"]); ?></td>
                                        <td><?php echo ($vo["status"]); ?></td>
                                        <td width="168px">
                                            <?php if($vo["status"] == 显示): ?><a href="__URL__/update/id/<?php echo ($vo["id"]); ?>/status/1" class="btn btn-xs blue"><i class="fa fa-edit"></i> 隐藏</a>
                                            <?php else: ?>
                                            <a href="__URL__/update/id/<?php echo ($vo["id"]); ?>/status/0" class="btn btn-xs red"><i class="fa fa-times"></i> 显示</a><?php endif; ?>
                                             <a href="__URL__/gview/id/<?php echo ($vo["id"]); ?>" class="btn btn-xs yellow"><i class="fa fa-file-o"></i> 详情</a>
                                        </td>
