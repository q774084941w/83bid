...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu">
        ...
        <?php if(is_array($left)): $i = 0; $__LIST__ = $left;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(empty($vo['children'])): ?><li class="tooltips" data-placement="right" data-original-title="点击<?php echo ($vo["name"]); ?>">
                ...
                <li class="">
                    ...
                    <ul class="sub-menu">
                        <?php if(is_array($vo['children'])): $i = 0; $__LIST__ = $vo['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li class="tooltips <?php echo ($thisNavigation1==$vo['controller'] ?'active':''); ?>" data-placement="right" data-original-title="点击查看<?php echo ($vol["name"]); ?>">
			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="__URL__/dlist">开发者列表</a></li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>聊天列表</div>
                            <div class="actions">
							</div>
						</div>
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        ...
                                        <td>
                                            <?php if(empty($$vo['sendneck'])): echo ($vo['senduname']); ?>
                                                <?php else: ?>
                                                <?php echo ($vo['sendneck']); endif; ?>
                                        </td>
										<td>
                                            <?php if(empty($$vo['responseneck'])): echo ($vo['responseuname']); ?>
                                                <?php else: ?>
                                                <?php echo ($vo['responseneck']); endif; ?>
                                        </td>
                                        <td><?php echo ($vo["time"]); ?></td>
                                        <td width="168px">
                                            <?php if($vo["status"] == 1): ?><a href="__URL__/update/id/<?php echo ($vo["chat_id"]); ?>/status/2"
                                                class="btn btn-xs red" style="width:50px;">
                                                    <i class="fa fa-times"></i> 关闭</a>
                                            <?php else: ?>
                                                <a href="__URL__/update/id/<?php echo ($vo["chat_id"]); ?>/status/1"
                                                class="btn btn-xs blue">
                                                    <i class="fa fa-edit"></i> 开启</a><?php endif; ?>
                                            <a href="__URL__/details/id/<?php echo ($vo["chat_id"]); ?>"
