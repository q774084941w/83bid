			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="__URL__/index">项目管理</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li><a href="__URL__/index">竞标者列表</a></li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>竞标者列表</div>
                            <div class="actions">
							</div>
						</div>
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
										...
										<td><?php echo ($vo["bidderid"]); ?></td>
										<td><?php echo ($vo["bid"]); ?></td>
                                        <td><span class="label label-sm label-success"><?php echo ($vo["status"]); ?></span></td>
										<td><?php echo ($vo["bidtime"]); ?></td>
