				...
				<div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-reorder"></i>账户详情</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    <h2 class="margin-bottom-20"> 用户账户信息 - No.<?php echo ($info["id"]); ?> </h2>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php if(empty($info['neckname'])): echo ($info["uname"]); ?>
                                                            <?php else: ?>
                                                            <?php echo ($info["neckname"]); endif; ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">交易ID:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["transid"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php echo ($info["monetary_icon"]); ?>
                                                        <?php echo ($info["transcash"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["transtime"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">转账类型:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <?php switch($info['transtype']): case "1": ?>充值<?php break;?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">￥<?php echo ($info["balance"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">转账说明:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo ($info["transinfo"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-offset-10 col-md-2">
                                                <a href="javaScript:history.back(-1)" class="btn purple"><i class="fa fa-share"></i> 返回</a>
                                            </div>
                                        </div>
