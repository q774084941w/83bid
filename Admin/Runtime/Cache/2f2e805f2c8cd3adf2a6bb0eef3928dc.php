                ...
                <!--表格开始-->
                    <div class="portlet box yellow">
					    <div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>添加账户信息</div>
							<div class="actions">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="__URL__/insert" method="post" id="form_sample_2" class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">用户ID<span class="required">*</span></label>
										<div class="col-md-4">
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">转账类型<span class="required">*</span></label>
										<div class="col-md-4">
											<div class="input-icon right">                                       
												<i class="fa"></i>   
												<input type="text" class="form-control" name="transtype"/>
											</div>
										</div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">交易方ID<span class="required">*</span></label>
										<div class="col-md-4">
											<div class="input-icon right">                                       
												<i class="fa"></i>   
