			...
			<!--<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="__URL__/index">站内信管理</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li><a href="__URL__/index">站内信列表</a></li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box light-grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>站内信列表</div>
                            <div class="actions">
								<a href="__URL__/add" class="btn green"><i class="fa fa-plus"></i> 添加站内信</a>
							</div>
						</div>
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
                                <thead>
									<tr>
                                        <!--<th class="table-checkbox"><input type="checkbox" class="group-checkable" data-set="" /></th>-->
                                        <th>#ID</th>
										<th>消息标题</th>
										<th>发送用户ID</th>
                                        <th>接收用户ID</th>
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
										...
										<td><?php echo ($vo["senderid"]); ?></td>
										<td><?php echo ($vo["receiverid"]); ?></td>
										<td class="center"><?php echo ($vo["sendtime"]); ?></td>
                                        <!--<td>
                                            <?php if($vo["outstatus"] == 已读): ?><span class="label label-sm label-success" style="background:#5384c4;"><?php echo ($vo["outstatus"]); ?></span>
                                            <?php else: ?>
                                            <span class="label label-sm label-success" style="background:#cd4938;"><?php echo ($vo["outstatus"]); ?></span><?php endif; ?>
                                        </td>-->
                                        <td width="168px">
