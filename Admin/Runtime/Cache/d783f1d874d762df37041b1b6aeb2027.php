                ...
                <!--表格开始-->
                    <div class="portlet box yellow">
					    <div class="portlet-title">
							<div class="caption"><i class="fa fa-user"></i>添加新商品</div>
							<div class="actions">
								...
								<div class="form-body">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												...
												<select name="projects" class="form-control">
													<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>,<?php echo ($vo["pnumber"]); ?>">
															<?php echo ($vo["pnumber"]); ?>
										...
										<div class="col-md-4">
											<div class="input-icon right">
												...
												<select name="monetary_id" class="form-control">
													<?php if(is_array($monetary)): $i = 0; $__LIST__ = $monetary;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>">
															<?php echo ($vo["title"]); ?>
														</option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="file" class="form-control" name="img" required onchange="xmTanUploadImg(this)"/>
												<img src="" alt="">
											</div>
										</div>
									</div>
