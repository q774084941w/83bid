				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom tabbable-full-width">
						<ul class="nav nav-tabs">
							<li><a href="__APP__/User/index">信息一览</a></li>
							<li class="active"><a href="__APP__/User/modinfo">信息修改</a></li>
						</ul>
								...
								<div class="row profile-account">
									<div class="col-md-3">
										<ul class="ver-inline-menu tabbable margin-bottom-10">
											<li >
												<a href="__APP__/User/modinfo">
												    <i class="fa fa-cog"></i> 
												    修改基本信息
												</a>                                    
											</li>
                                            <li class="active">
                                                <a href="__APP__/User/modavatar">
