				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom tabbable-full-width">
						<ul class="nav nav-tabs">
							<li class="active"><a href="__APP__/Comments/esent">发出的评论</a></li>
                            <li><a href="__APP__/Comments/ereceived">收到的评论</a></li>
							<li><a href="__APP__/Comments/eundone">未完成的评论</a></li>
						</ul>
                                            ...
                                            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="timeline-blue">
                                                ...
                                                <div class="timeline-body">
                                                    ...
                                                    <div class="timeline-footer">
                                                        <a href="__APP__/Comments/eview/id/<?php echo ($vo["id"]); ?>" class="nav-link pull-left">
