				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom tabbable-full-width">
						<ul class="nav nav-tabs">
							<li class="active"><a href="__APP__/UserProjects/releasedo">发布的项目</a></li>
							<li><a href="__APP__/UserProjects/biddendo">中标的项目</a></li>
								...
								<div class="row profile-account">
									<div class="col-md-2">
										<ul class="ver-inline-menu tabbable margin-bottom-10">
											<li >
												<a href="__APP__/UserProjects/releasedo">
		                                            <i class="fa fa-rocket"></i> 
												    正在进行的
												</a>                                    
											</li>
                                            <li class="active">
                                                <a href="__APP__/UserProjects/releasebid">
                                            ...
                                            <li >
                                                <a href="__APP__/UserProjects/releasedone">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="add-portfolio">
                                                            ...
                                                            <a href="#" class="btn icn-only green pull-right">发布新项目 <i class="m-icon-swapright m-icon-white"></i></a>                          
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row portfolio-block">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="portfolio-info">
                                                            竞标人数
                                                            <span><?php echo ($vo["bidnum"]); ?></span>
                                                        </div>
                                                        <div class="portfolio-info">
                                                            竞标时长
                                                            <span><?php echo ($vo["biddingtime"]); ?>小时</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 portfolio-btn">
                                                        <a href="__APP__/UserProjects/releasebidders/pnumber/<?php echo ($vo["pnumber"]); ?>" class="btn bigicn-only"><span>查看</span></a>
                                                        <a href="__APP__/UserProjects/shut/id/<?php echo ($vo["id"]); ?>" class="btn bigicn-only"><span>关闭项目</span></a>
                                                    </div>
