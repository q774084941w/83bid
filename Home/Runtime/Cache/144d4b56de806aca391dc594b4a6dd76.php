				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom tabbable-full-width">
						<ul class="nav nav-tabs">
							...
							<li class="active"><a href="__APP__/UserProjects/bidding">竞标的项目</a></li>
						</ul>
                            ...
                            <div class="tab-pane active">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row portfolio-block">
                                    ...
                                    <div class="col-md-2 portfolio-btn">
                                        <a href="__APP__/Projects/view/id/<?php echo ($vo["pid"]); ?>" class="btn bigicn-only"><span>查看</span></a>
                                        <!--<a href="#" class="btn bigicn-only"><span>放弃竞标</span></a>-->
                                    </div>
