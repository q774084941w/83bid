				...
				<div class="col-md-2">
					<ul class="inbox-nav margin-bottom-10">
						<li class="compose-btn">
							<a href="__URL__/compose"> 
							<i class="fa fa-edit"></i> 写信
							</a>
						</li>
						<li class="inbox active">
							<a href="__URL__/index">收件箱</a>
							<b></b>
						</li>
						<li class="sent"><a href="__URL__/sent">发件箱</a><b></b></li>
						<li class="draft"><a href="__URL__/draft">草稿箱</a><b></b></li>
						<li class="trash"><a href="__URL__/trash">回收站</a><b></b></li>
					</ul>
				</div>
				<div class="col-md-10">
					<div class="inbox-header">
						<h1 class="pull-left"></h1>
						<form class="form-inline pull-right" action="no">
	...
	<thead>
		<tr>
			<th colspan="3">
				...
				<div class="btn-group">
					<a class="btn btn-sm blue" href="" data-toggle="dropdown"> 更多
					<i class="fa fa-angle-down"></i>
					</a>
					<ul class="dropdown-menu">
						<li><button type="submit" name="instatus" value="1" style="background:#fff;border:0px;"><i class="fa fa-pencil"></i> 标记为已读</button></li>
                        <!--<li><a href=""><i class="fa fa-ban"></i> 标记为垃圾邮件</a></li>-->
						<li class="divider"></li>
						<li><button type="submit" name="instatus" value="2" style="background:#fff;border:0px;"><i class="fa fa-trash-o"></i> 放入回收站</a></li>
					</ul>
				</div>
			</th>
	...
	<tbody>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="unread">
			<td class="inbox-small-cells">
                <input type="checkbox" class="mail-checkbox" name="ids[]" value="<?php echo ($vo["id"]); ?>">
			</td>
            <td class="inbox-small-cells"><i class="fa fa-star 
                    <?php if($vo["instatus"] == 0): ?>inbox-started<?php endif; ?>
                    "></i></td>
            <td class="view-message  hidden-xs"><?php echo ($vo["uname"]); ?></td>
            <td class="view-message "><a href="__URL__/view/id/<?php echo ($vo["id"]); ?>/active/index" style="color:#777;"><?php echo ($vo["title"]); ?></a></td>
			<td class="view-message  inbox-small-cells"><i class="fa fa-paper-clip"></i></td>
            <td class="view-message  text-right" style="width:150px;"><?php echo ($vo["sendtime"]); ?></td>
