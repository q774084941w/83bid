                            ...
                            <div class="row profile-account">
                                <div class="col-md-2">
                                    <ul class="ver-inline-menu tabbable margin-bottom-10">
                                        <li class="active">
                                            <a href="__APP__/Accounts/transout">
                                        ...
                                        <li >
                                            <a href="__APP__/Accounts/transin">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="add-portfolio">
                                                        <span>账户余额：<?php echo ($balance); ?></span>
                                                        <a href="__APP__/Accounts/add" class="btn icn-only green pull-right">新增转账 <i class="m-icon-swapright m-icon-white"></i></a>                          
                                                    </div>
                                                </div>
                                            </div>
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有转账信息！" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row portfolio-block">
                                                <div class="col-md-5">
                                                    <div class="portfolio-text">
                                                        <img src="__ROOT__/Uploads/users/<?php echo ($vo["avatar"]); ?>" alt=""  style="width:80px;height:80px" />
                                                        <div class="portfolio-text-info">
                                                            <h4>交易用户：<?php echo ($vo["uname"]); ?></h4>
                                                            <p>转账说明：<?php echo ($vo["transinfo"]); ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="portfolio-info">
                                                        金额
                                                        <span>￥<?php echo ($vo["transcash"]); ?></span>
                                                    </div>
                                                    <div class="portfolio-info">
                                                        转账时间
                                                        <span><?php echo ($vo["transtime"]); ?></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 portfolio-btn">
                                                    <a href="__APP__/Accounts/view/id/<?php echo ($vo["id"]); ?>" class="btn bigicn-only"><span>查看</span></a>
                                                </div>
                                            </div><?php endforeach; endif; else: echo "暂时没有转账信息！" ;endif; ?>
                                            <!--end row--> 
                                        </div>
                                        <!--end tab-pane-->
                                    </div>
