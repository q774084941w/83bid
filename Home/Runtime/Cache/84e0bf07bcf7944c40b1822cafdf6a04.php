											...
											<div class="tab-pane active">
                                                ...
                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row portfolio-block">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="portfolio-info">
                                                            项目开始时间
                                                            <span><?php echo ($vo["bidtime"]); ?></span>
                                                        </div>
                                                        <div class="portfolio-info">
                                                            项目时长
                                                            <span><?php echo ($vo["projecttime"]); ?>小时</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 portfolio-btn">
                                                        <a href="__APP__/Projects/view/id/<?php echo ($vo["id"]); ?>" class="btn"><span>查看</span></a>
                                                        <?php if($vo["status"] == 2): ?><a href="__APP__/UserProjects/pa/id/<?php echo ($vo["id"]); ?>" class="btn"><span>支付佣金</span></a><?php endif; ?>
