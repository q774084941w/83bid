				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom tabbable-full-width">
						<ul class="nav nav-tabs">
							<li class="active"><a href="__APP__/User/index">信息一览</a></li>
                            <li><a href="__APP__/User/modinfo">信息修改</a></li>
						</ul>
								...
								<div class="row">
									<div class="col-md-3">
										<ul class="list-unstyled profile-nav">
											<li><img src="__ROOT__/Uploads/users/<?php echo ($info["avatar"]); ?>" class="img-responsive" alt="" /> 
												<a href="__URL__/modavatar" class="profile-edit">编辑</a>
											</li>
											<li><a href="__APP__/Accounts/index">我的账户</a></li>
											<li><a href="__APP__/UserProjects/index">我的项目</a></li>
											<li><a href="__APP__/Comments/">我的评论</a></li>
											<li><a href="__APP__/Points/index">我的积分</a></li>
										</ul>
									</div>
									<div class="col-md-9">
										<div class="row">
											<div class="col-md-8 profile-info">
                                                <h1><?php echo ($info["uname"]); ?></h1> 
                                                <p>
                                                    <?php echo (($info["dselfintro"])?($info["dselfintro"]):"用户没有输入自我介绍！"); ?>
                                                </p>
												<ul class="list-inline">
                                                    <li><i class="fa fa-map-marker"></i> <?php echo (($info["location"])?($info["location"]):"用户未填写"); ?></li>
                                                    <li><i class="fa fa-calendar"></i> <?php echo ($info["addtime"]); ?></li>
                                                    <li><i class="fa fa-envelope"></i> <?php echo ($info["email"]); ?></li>
                                                    <li><i class="fa fa-mobile"></i> <?php echo (($info["phone"])?($info["phone"]):"用户电话未填写"); ?></li>
                                                    <li><i class="fa fa-heart"></i> <?php echo ($info["rank"]); ?></li>
                                                    <li><i class="fa fa-tags"></i> <?php echo (($info["skills"])?($info["skills"]):"用户技能未填写"); ?></li>
												</ul>
											</div>
											<!--end col-md-8-->
											<div class="col-md-4">
												<div class="portlet sale-summary">
													<div class="portlet-title">
														<div class="caption">信息统计</div>
													</div>
													<div class="portlet-body">
														<ul class="list-unstyled">
															<li>
																<span class="sale-info">开发者声誉 <i class="fa fa-img-up"></i></span> 
                                                                <span class="sale-num"><?php echo ($info["dlevel"]); ?></span>
															</li>
															<li>
																<span class="sale-info">雇佣者声誉 <i class="fa fa-img-down"></i></span> 
                                                                <span class="sale-num"><?php echo ($info["elevel"]); ?></span>
															</li>
															<li>
																<span class="sale-info">发布项目数</span> 
                                                                <span class="sale-num"><?php echo ($info["outpronum"]); ?></span>
                                                            </li>
                                                            <li>
																<span class="sale-info">完成项目数</span> 
                                                                <span class="sale-num"><?php echo ($info["inpronum"]); ?></span>
															</li>
															<li>
																<span class="sale-info">项目总收益</span> 
                                                                <span class="sale-num">￥<?php echo (($info["income"])?($info["income"]):'0.0'); ?></span>
															</li>
														</ul>
													</div>
												</div>
