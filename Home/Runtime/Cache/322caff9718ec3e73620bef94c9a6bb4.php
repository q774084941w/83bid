                            ...
                            <table class="table table-striped table-bordered table-advance table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fa fa-tags"></i> 获得积分</th>
                                        <th><i class="fa fa-clock-o"></i> 获得积分时间</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <td><span class="label label-success label-sm"><?php echo ($vo["points"]); ?></span></td>
                                        <td><a class="btn default btn-xs green-stripe"><?php echo ($vo["pointstime"]); ?></a></td>
