                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    <h2 class="margin-bottom-20"> 转账详情 - No.<?php echo ($info["id"]); ?> </h2>
                                    <h3 class="form-section">基本信息</h3>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">转出用户:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo (($info["outuname"])?($info["outuname"]):'系统'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">转入用户:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?php echo (($info["inuname"])?($info["inuname"]):'系统'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">￥<?php echo ($info["transcash"]); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-offset-10 col-md-2">
                                                <a href="__APP__/Accounts/index" class="btn purple"><i class="fa fa-share"></i> 返回</a>
                                            </div>
                                        </div>
