		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand logo-v1" href="__APP__" style="padding:0;padding-left:20px">
					<img src="__PUBLIC__/<?php echo ($sysmanage["logo"]); ?>" id="logoimg" alt="logo">
				</a>
				<!-- END LOGO -->
			</div>
			...
			<div class="row">
				...
				<div class="col-md-9 col-sm-9 blog-posts margin-bottom-40">
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row">
						...
						<div class="col-md-8 col-sm-8">
                            <h2><a href="__URL__/view/id/<?php echo ($vo["id"]); ?>"> <?php echo ($vo["uname"]); ?></a></h2>
							<ul class="blog-info">
                                <li><i class="fa fa-calendar"></i> <?php echo ($vo["addtime"]); ?></li>
                                <li><i class="fa fa-comments"></i> <?php echo ($vo["elevel"]); ?></li>
                                <li><i class="fa fa-tags"></i> <?php echo (($vo["skills"])?($vo["skills"]):"用户暂未填写"); ?></li>
							</ul>
                            <p><?php echo ($vo["dselfintro"]); ?></p>
                            <a class="more" href="__URL__/view/id/<?php echo ($vo["id"]); ?>">查看更多 <i class="icon-angle-right"></i></a>
						</div>
					</div>
				...
				<div class="col-md-3 col-sm-3 blog-sidebar">
					<!-- CATEGORIES START -->
					<h2 class="no-top-space">雇佣者所属地区</h2>
					<ul class="nav sidebar-categories margin-bottom-40">
						<li><a href="">东北地区</a></li>
						<li><a href="">华东地区</a></li>
						<li><a href="">华北地区</a></li>
						<li class="active"><a href="">华南地区</a></li>
						<li><a href="">华中地区</a></li>
						<li><a href="">西北地区</a></li>
						<li><a href="">西南地区</a></li>
					</ul>
