		...
		<div class="container min-hight">
			...
			<div class="row">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row">
						...
						<div class="col-md-8 col-sm-8">
							...
							<ul class="blog-info">
                                ...
                                <li><i class="fa fa-comments"></i> <?php echo ($vo["dlevel"]); ?></li>
                                <li><i class="fa fa-tags"></i> <?php echo ($vo["skills"]); ?></li>
							</ul>
				...
				<div class="col-md-3 col-sm-3 blog-sidebar">
					<!-- CATEGORIES START -->
					<h2 class="no-top-space">开发者所属地区</h2>
